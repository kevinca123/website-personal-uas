window.addEventListener("load", event => {
    ...
    function productHeading() {
        ...
        function getDisccount() {
            priceOriginal.innerText = product.value + "rp. 3.000.000 ";
            discount = product.value - (product.value * (30 / 100));
            priceFinal.innerText = discount + "rp";
        }
        ...
        function getPrice() {
            ...
            priceFinal.innerText = discount * inputQuantity.value + "rp. 3.000.000 ";
            priceOriginal.innerText = product.value * inputQuantity.value + "rp";
